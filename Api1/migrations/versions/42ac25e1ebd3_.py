...
Revision ID: 42ac25e1ebd3
Revises: 
Create Date: 2019-11-16 06:29:15.415618
...
def upgrade():
    ...
    sa.Column('subtitle', sa.VARCHAR(), nullable=False),
    sa.Column('mainImageUrl', sa.VARCHAR(), nullable=True),
