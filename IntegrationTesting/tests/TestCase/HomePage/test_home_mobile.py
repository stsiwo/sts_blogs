...
import pytest
pytestmark = [pytest.mark.mobile, pytest.mark.home]


# COMMMON
def test_home_title(target_driver_with_base_url_with_mobile_ssize):

    home_page = HomePage(target_driver_with_base_url_with_mobile_ssize)

    assert home_page.is_title_matches('STS')


@pytest.mark.scroll
def test_should_not_display_scroll_y(target_driver_with_base_url_with_mobile_ssize):
    """
...
# HEADER
def test_should_display_title_in_header(target_driver_with_base_url_with_mobile_ssize):
...
def test_should_not_display_blogs_nav_menu_item_in_header(target_driver_with_base_url_with_mobile_ssize):
...
def test_should_display_nav_menu_toggle_icon_in_header(target_driver_with_base_url_with_mobile_ssize):
...
def test_should_display_nav_menu_bar_in_header_when_click_menu_toggle_icon(target_driver_with_base_url_with_mobile_ssize):
    ...
    assert home_page.get_size_of_element_in_header('menu')['width'] >= cfg.ssize_width_mobile - 50  # extra width. just in case for selenium does not wait for full width


def test_should_close_nav_menu_bar_in_header_when_click_menu_close_btn(target_driver_with_base_url_with_mobile_ssize):
...
def test_should_route_to_blog_list_page_when_click_blogs_link_in_header(target_driver_with_base_url_with_mobile_ssize):
    ...
    blog_list_page = BlogListPage(target_driver_with_base_url_with_mobile_ssize)
...
def test_should_route_to_signup_page_when_click_blogs_link_in_header(target_driver_with_base_url_with_mobile_ssize):
    ...
    signup_page = SignupPage(target_driver_with_base_url_with_mobile_ssize)
...
def test_should_route_to_login_page_when_click_blogs_link_in_header(target_driver_with_base_url_with_mobile_ssize):
    ...
    login_page = LoginPage(target_driver_with_base_url_with_mobile_ssize)
...
# HOME
def test_should_route_search_result_page_when_search_in_home(target_driver_with_base_url_with_mobile_ssize):
...
def test_should_route_signup_page_when_join_btn_is_clicked_in_home(target_driver_with_base_url_with_mobile_ssize):
...
def test_should_display_5_blog_item_at_initial_load(target_driver_with_base_url_with_mobile_ssize):
...
def test_should_fetch_popular_blog_when_click_popular_btn(target_driver_with_base_url_with_mobile_ssize):
...
# FOOTER
def test_should_display_footer_content_of_about_me(target_driver_with_base_url_with_mobile_ssize):
