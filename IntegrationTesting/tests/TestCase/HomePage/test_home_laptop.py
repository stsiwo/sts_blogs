...
@pytest.mark.visible
def test_should_blogs_nav_item_to_be_visible(target_driver_with_base_url_with_laptop_ssize):

    home_page = HomePage(target_driver_with_base_url_with_laptop_ssize)

    assert home_page.is_blogs_nav_menu_item_visible() == 1
...
def test_should_display_blogs_nav_menu_item_in_header(target_driver_with_base_url_with_laptop_ssize):
...
def test_should_display_signup_nav_menu_item_in_header(target_driver_with_base_url_with_laptop_ssize):
...
def test_should_display_login_nav_menu_item_in_header(target_driver_with_base_url_with_laptop_ssize):
